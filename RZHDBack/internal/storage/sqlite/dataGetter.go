...
func (pdg ProductionDataGetter) GetDFiftyProds() (*[]model.DieselDFiftySeries, error) {
	const op = "sqlite.ProductionDataGetter.GetDFiftyProds"
...
func (pdg ProductionDataGetter) GetPrivateProductions() (*[]model.PrivateProduct, error) {
	const op = "sqlite.ProductionDataGetter.GetPrivateProductions"
...
func (pdg ProductionDataGetter) GetMajorRepProduction() (*[]model.MajorRepair, error) {
	const op = "sqlite.ProductionDataGetter.GetMajorRepProduction"
	...
	qPhotosGetter := `SELECT photo_path FROM cap_rep_productions_photos WHERE production_id = ?`
...
func (pdg ProductionDataGetter) GetRepairHubsAggregators() (*[]model.RepairHubsAggregatorsProduct, error) {
	const op = "sqlite.ProductionDataGetter.GetRepairHubsAggregators"
	...
	qPhotosGetter := `SELECT photo_path FROM repair_hub_aggregator_photos WHERE production_id = ?`
